:original_name: apig-en-api-180328008.html
...
#. Import the sample project to Eclipse.
   ...
   .. figure:: /_static/images/en-us_image_0132432937.png
      :alt: **Figure 1** Selecting an existing project

      **Figure 1** Selecting an existing project


   .. figure:: /_static/images/en-us_image_0132432939.png
   ...
   .. figure:: /_static/images/en-us_image_0132518357.png
...
#. Edit the main method in the **Demo.java** file.
   ...
   For details on how to obtain your region name, service name, AK/SK, project ID, and domain ID, see :ref:`Obtaining Required Information <apig-en-api-180328009>`.
...
#. (Optional) To call a service API of a sub-project or to add a self-defined header, perform the following steps:
   ...
   b. .. _apig-en-api-180328008__li11427145613263:
   ...
   c. Repeat :ref:`4.b <apig-en-api-180328008__li11427145613263>` to add other self-defined headers.
